...
public class ClaimSheetDataPanel extends javax.swing.JPanel {

    /** Creates new form EclaimDataPanel */
    public ClaimSheetDataPanel()
    {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        claimNumber.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
        ...
        trackingNumber.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                tackingNumberKeyTyped(evt);
            }
        });

        jLabel8.setText("Tracking  Number 1Z-009-710-90:");

        jLabel9.setText("Date Returned (yyyy-mm-dd):");
    ...
    /**
     * Called when a laptop models has been selected from the drop menu.
     * @param evt
     */
    ...
    /**
     * Called when part 1 has been selected from the drop menu.
     * @param evt
     */
    ...
    /**
     * Called when part 3 has been selected.
     * @param evt
     */
    ...
    /**
     * Called when something has been typed in the description text area, to check for wording really.
     * @param evt
     */
    ...
    /**
     * Called when a tracking number has been typed in, checking for proper formatting.
     * @param evt
     */
    private void tackingNumberKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tackingNumberKeyTyped

            trackingNumber.setText(this.trackingNumber.getText().replaceAll("1Z00971090", ""));
    }//GEN-LAST:event_tackingNumberKeyTyped

    private void valueChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_valueChange

    }//GEN-LAST:event_valueChange

    /**
     * Called when a laptop ID has been typed. The basic purpose is to check the format and predict the laptop model.
     * @param evt
     */
    private void laptopIDKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_laptopIDKeyTyped
        ...
        if(this.laptopID.getText().length() >= 7 && evt.getKeyChar() != 8)AutomaticLaptopIdentifier.isValid(laptopID.getText());
    }//GEN-LAST:event_laptopIDKeyTyped

    /**
     * Updates all the parts boxes to display the correct parts for the corresponding laptop model.
     */
    ...
    /**
     * Updates the drop down menu containing list of laptop models.
     */
