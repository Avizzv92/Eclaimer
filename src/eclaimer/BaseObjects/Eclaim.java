...
public class Eclaim implements Comparable<Eclaim>, Serializable
{
    ...
    /**
     * Returns a fully defined Eclaim object.
     *
     ...
     * @return an Eclaim object
     */
    public Eclaim(String claim, String id, String model, String firstPart, String secondPart, String thirdPart, boolean protec, String description)
    {
        claimNumber = claim;
        laptopID = id;
        laptopModel = model;
    ...
    /**
     * Compares Eclaim objects based on their claim number. This helps in the sorting process.
     *
     * @param  e the Eclaim to compare this to.
     * @return  the comparison result.
     */
    @Override
    public int compareTo(Eclaim e)
    {
    ...
    public String getLaptopModelForNumber(String number)
    {
     ...
     /**
     * Gets the string description of this Eclaim, used mainly in the table.
     *
    ...
    {
        String returnString = "EClaim #: " + this.getClaimNumber() + " | ID: " + this.getLaptopID() + " | Model: " + this.getLaptopModel() + " | Description: " + this.getProblemDescription();
        return returnString;
    }
}
